# Generated by Django 5.2.5 on 2025-08-16 08:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('questions', models.ManyToManyField(related_name='exams', to='exam_system.question')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('violations_log', models.JSONField(default=list)),
